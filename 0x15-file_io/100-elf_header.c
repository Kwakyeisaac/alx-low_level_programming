 ...
 * @e_ident: its a pointer to an array containing the ELF magic number
 ...
 * @e_ident: A pointer to an array conataining the ELF class
 */
void print_data(unsigned char *e_ident)
{
	printf(" Data: ");
...
/**
 * print_abi - it prints the ABI versionof an ELF header
...
/**
 * print_type - it prints the types of an ELF header
 * @e_type: The ELF type
 * @e_ident: A pointer to an array containing the ELF class
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
...
/**
 * close_elf - it closes an EFL file
 ...
 * @argc: the number the args supplied to the program
